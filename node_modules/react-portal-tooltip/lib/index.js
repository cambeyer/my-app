...
var Card = (function (_Component) {
  ...
  function Card() {
    ...
    this.handleMouseEnter = function () {
      _this.props.active && _this.setState({ hover: true });
    };
  ...
  _createClass(Card, [{
    ...
    value: function getStyle(position, arrow) {
      ...
      var stylesFromPosition = {
        ...
        top: function top() {
          style.left = _left - _this2.state.width / 2 + parentSize.width / 2;
      ...
      var stylesFromArrow = {
        left: function left() {
          style.left = _left + parentSize.width / 2 - _this2.margin;
        },
        right: function right() {
          style.left = _left - _this2.state.width + parentSize.width / 2 + _this2.margin;
        },
        top: function top() {
